...
public class UpdateMealController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updateMealPackage(title_mealpackage, quantity, price, discount_price, thumbnail, description, recipe, create_at, update_at, status, bird_id, lifecycle_id, img, meal_package_id);
